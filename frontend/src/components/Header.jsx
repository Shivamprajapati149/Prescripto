...
const Header = () => {
  return (
    <div
      ...
      className="flex flex-col md:flex-row flex-wrap rounded-lg px-20  md:px-10 lg:px-25"
    >
      {/* leftside */}
      <div className="md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]">
        ...
        <div className="flex flex-col md:flex-row items-center text-white text-sm font-light">
          ...
          <p>
            Simply browse through our extensive list of trusted list of thrusted
            doctors, <br className="hidden sm:block" />
